...
const hemisphereLight =
    new THREE.HemisphereLight(0xffffff, 0x555555, 1.2);
...
const grassMaterial = [
    makeMaterial(grassSideTexture),
    makeMaterial(grassSideTexture),
    makeMaterial(grassTopTexture),
    makeMaterial(grassSideTexture),
    makeMaterial(grassSideTexture),
    makeMaterial(grassSideTexture)
];
...
const woodMaterial = [
    makeMaterial(woodSideTexture),
    makeMaterial(woodSideTexture),
    makeMaterial(woodTopTexture),
    makeMaterial(woodTopTexture),
    makeMaterial(woodSideTexture),
    makeMaterial(woodSideTexture)
];
